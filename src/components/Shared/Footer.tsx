const Footer = () => {
  return (
    <footer className="mt-10 px-2 md:px-0 divide-y w-[90%] md:w-[90%] lg:w-[80%] mx-auto max-w-[1440px] font-lato pt-10">
          ...
          <div className="space-y-3 col-span-2 md:col-span-1 pb-5 md:pb-0">
            ...
            <ul className="space-y-1">
              ...
              <li className="flex gap-1">
                <a className="" rel="noopener noreferrer" href="#">
                  Address: Sloana Beach, California{" "}
                </a>
              </li>
            </ul>
          </div>
      ...
      <div className="py-3 md:py-0 flex flex-col-reverse md:flex-row items-center justify-between">
        <div className="py-3 md:my-3 text-sm text-center">
        ...
        <div className="flex justify-start space-x-3">
          ...
          >
            <svg
              ...
              fill="currentColor"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current text-[#5144e6]"
            >
          ...
          >
            <svg
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
              className="w-5 h-5 fill-current text-[#44a3e6]"
            >
